    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted flex items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md transition-all duration-300 ease-in-out">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">D&D Spells</CardTitle>
          <CardDescription>Acesse sua conta para gerenciar seus favoritos</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <TabsContent value="signin" className="animate-slide-in-right">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <div className="text-center">
                  <button
                    type="button"
                    className="text-sm text-neon-yellow hover:underline"
                    onClick={() => {
                      toast({
                        title: "Recuperação de senha",
                        description: "Em breve implementaremos esta funcionalidade.",
                      });
                    }}
                  >
                    Esqueci Minha Senha
